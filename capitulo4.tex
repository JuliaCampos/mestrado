...
Uma solução para um PSR é uma sequência de valores para todas as suas variáveis, de modo que todas as restrições sejam satisfeitas.
%Considerando um PSR $(R, \Omega\varepsilon)$, com  $\Omega\varepsilon = \{x_1 \in \Omega_1, x_2 \in \Omega_2, \dots, x_n \in \Omega_n \}$. É dito que uma n-tupla $(\omega_1, \omega_2, \dots, \omega_n) \in \Omega_1 \times \dots \times \Omega_n$ satisfaz uma restrição $R$, em um conjunto específico de restrições $R'$, sobre um conjunto de variáveis $X = \{x_{i1}, x_{i2}, \dots, x_{im}\}$ se $(\omega_1, \omega_2, \dots, \omega_n) \in R$. Então uma n-tupla $(\omega_1, \omega_2, \dots, \omega_n) \in \Omega_1 \times \dots \times \Omega_n$ é a solução para $(R,\Omega\varepsilon)$ se satisfaz toda restrição $R \in R'$. 
